...
typedef enum {
    ...
    DESIGN_FONT_ATTENTION_ACTION,
    DESIGN_FONT_AUDIO_TITLE, DESIGN_FONT_AUDIO_VALUE, DESIGN_FONT_AUDIO_DEVICE, DESIGN_FONT_AUDIO_PICKER,
    DESIGN_FONT_SPEED_DIAL_LABEL,
