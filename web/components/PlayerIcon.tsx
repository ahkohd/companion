...
export function PlayerIcon({player,size=20}:{player:PlayerId;size?:number}) {
  ...
  if(player==='roon')return <img src="/icons/players/roon.png" width={size} height={size} alt="" aria-hidden="true"/>
  if(player==='appleMusic')return <img src="/icons/players/apple-music.png" width={size} height={size} alt="" aria-hidden="true"/>
