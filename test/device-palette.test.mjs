...
test('native semantic palette retains accents and themes face coverage',()=>{
 ...
 execFileSync('cc',['-std=c11','-O2','-Wall','-Wextra','-Werror','-Ifirmware/main',`-I${cjson}`,'test/device-palette-probe.c','firmware/main/display_module.c','firmware/main/face_model.c',`${cjson}/cJSON.c`,'-lm','-o',binary]);
